...
const TRIP = {
  ...
  "days": [
    {
      ...
      "items": [
        ...
        { "id": "d1-bic", "time": "오후", "emoji": "⌨️", "title": "빅카메라 유라쿠초 (해피해킹 면세)", "who": ["엘리"],
          "desc": "긴자·유라쿠초 대형 가전. 고급 키보드 코너에서 해피해킹 타건·구매. 면세 10% + 여행객 쿠폰(가전 7% 등)이면 더 저렴. 오에도 골동시장이 유라쿠초라 바로 옆! ⚠️ 면세는 여권 필수, 상자 라벨 US Layout(英語配列) 확인.",
          "search": "Bic Camera Yurakucho", "lat": 35.6749, "lon": 139.7636 },
    ...
    },
    {
      ...
      "items": [
        ...
        { "id": "d5-yodobashi", "time": "늦오후", "emoji": "⌨️", "title": "요도바시 아키바 (해피해킹 면세)", "who": ["엘리"],
          "desc": "아키하바라역 직결 초대형 요도바시. 키보드 타건존이 커서 해피해킹 모델별(Type-S·하이브리드·클래식) 소리·키감 비교 최고. US배열(英語配列) 재고도 비교적 자주. 아들 가챠 도는 동안 엘리 인생 키보드 득템! ⚠️ 면세 여권 필수.",
          "search": "Yodobashi Camera Akiba", "lat": 35.6986, "lon": 139.7745 },
  ...
  "tips": [
    ...
    { "id": "tip-hhkb", "emoji": "⌨️", "title": "해피해킹 면세 득템 (엘리)",
      "desc": "일본 가전은 면세 10%라 HHKB 사기 좋은 기회. 매장: 요도바시 아키바(7/9)·빅카메라 유라쿠초(7/5), 둘 다 이미 가는 동네. ① 상자 라벨에서 US Layout(英語配列) 꼭 확인 ② 화이트 변색 걱정 X (PBT라 십 년 써도 그대로) ③ 면세는 계산 시 실물 여권 필수!" }
  ]
};
