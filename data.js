    ...
    },
    {
      ...
      "items": [
        ...
        { "id": "d5-charstreet", "time": "오후", "emoji": "👒", "title": "도쿄역 캐릭터 스트리트", "who": ["엘리", "진유"],
          "desc": "도쿄역 지하 캐릭터숍 거리. 원피스 밀짚모자 스토어 도쿄역점 (상설 최대 규모)! 점프숍·포켓몬·가챠도 줄줄이.",
          "search": "Tokyo Character Street Tokyo Station", "lat": 35.6812, "lon": 139.7665 },
        { "id": "d5-jimbocho", "time": "오후", "emoji": "📚", "title": "진보초 책방거리", "who": ["엘리"],
          "desc": "세계 최대 헌책방 거리 — 고서점 100곳+, 빈티지 문구·판화·고지도. 목요일이라 다 열어!",
